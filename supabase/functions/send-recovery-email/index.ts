              ...
              <table role="presentation" style="width: 100%; margin-bottom: 24px;">
                <tr>
                  <td style="background: linear-gradient(135deg, #8B5CF6 0%, #A855F7 100%); padding: 24px; border-radius: 12px; text-align: center;">
                    ...
                    <p style="margin: 0 0 4px 0; font-size: 16px; color: rgba(255,255,255,0.7); text-decoration: line-through;">De R$ 179,90</p>
                    ...
                    <p style="margin: 8px 0 0 0; font-size: 14px; color: #4ADE80; font-weight: bold;">Economia total de R$ 92,60! 🎉</p>
