...
<tr><td style="padding:32px;">
<p style="margin:0 0 20px 0;font-size:18px;color:#2d3319;font-weight:bold;">${sampleData.firstName}, você realmente vai desistir do seu cabelo?</p>
...
<table role="presentation" style="width:100%;margin-bottom:24px;border:1px solid #dde4cc;border-radius:12px;overflow:hidden;">
<tr><td style="background-color:#f4f7ec;padding:12px 16px;border-bottom:1px solid #dde4cc;"><p style="margin:0;font-size:14px;font-weight:bold;color:#3d4a24;">📦 Seu Pedido Pendente</p></td></tr>
<tr><td style="padding:16px;">
<table role="presentation" style="width:100%;">
<tr><td style="padding:4px 0;font-size:14px;color:#6B7280;">Pedido nº</td><td style="padding:4px 0;font-size:14px;color:#111827;text-align:right;font-weight:600;">#${sampleData.transactionId}</td></tr>
<tr><td style="padding:4px 0;font-size:14px;color:#6B7280;">Produto</td><td style="padding:4px 0;font-size:14px;color:#111827;text-align:right;">${sampleData.productName}</td></tr>
<tr><td style="padding:4px 0;font-size:14px;color:#6B7280;">Valor original</td><td style="padding:4px 0;font-size:14px;color:#111827;text-align:right;">${sampleData.formattedAmount}</td></tr>
<tr><td colspan="2" style="padding:8px 0 0 0;border-top:1px solid #dde4cc;"></td></tr>
<tr><td style="padding:4px 0;font-size:14px;color:#608C1A;font-weight:bold;">Com cupom VOLTEI10</td><td style="padding:4px 0;font-size:16px;color:#608C1A;text-align:right;font-weight:bold;">-10% 🎉</td></tr>
</table>
</td></tr></table>
<table role="presentation" style="width:100%;margin-bottom:24px;"><tr><td align="center">
<a href="${sampleData.checkoutUrl}" style="display:inline-block;background:linear-gradient(135deg,#739926 0%,#608C1A 100%);color:#ffffff;text-decoration:none;padding:16px 48px;border-radius:12px;font-size:18px;font-weight:bold;box-shadow:0 4px 12px rgba(96,140,26,0.4);">Quero cuidar do meu cabelo! 💚</a>
</td></tr></table>
<table role="presentation" style="width:100%;margin-bottom:24px;"><tr><td style="padding:16px;background-color:#fef9e7;border-radius:8px;border-left:4px solid #d4a017;">
<p style="margin:0;font-size:14px;color:#7a5c00;">⏰ <strong>Atenção:</strong> Este cupom é válido apenas por 24 horas. Não deixe para depois!</p>
</td></tr></table>
<p style="margin:0 0 8px 0;font-size:14px;color:#555;text-align:center;line-height:1.6;"><strong>+2.000 mulheres</strong> já transformaram seus cabelos com PowerHair.</p>
<p style="margin:0;font-size:14px;color:#555;text-align:center;line-height:1.6;">Não fique de fora dessa transformação! ✨</p>
</td></tr>
<tr><td style="padding:24px;background-color:#f4f7ec;border-radius:0 0 16px 16px;text-align:center;">
<p style="margin:0 0 8px 0;font-size:12px;color:#888;">Pedido #${sampleData.transactionId}</p>
<p style="margin:0;font-size:12px;color:#888;">© 2025 PowerHair. Todos os direitos reservados.</p>
...
<tr><td style="padding:32px;">
<p style="margin:0 0 24px 0;font-size:16px;color:#2d3319;">Olá <strong>${sampleData.firstName}</strong>! 🎉</p>
<p style="margin:0 0 24px 0;font-size:16px;color:#555;line-height:1.6;">Ótimas notícias! Seu pedido foi enviado e já está a caminho. Use o código de rastreio abaixo para acompanhar a entrega.</p>
<table role="presentation" style="width:100%;margin-bottom:24px;"><tr><td style="background:linear-gradient(135deg,#739926 0%,#608C1A 100%);padding:24px;border-radius:12px;text-align:center;">
<p style="margin:0 0 8px 0;font-size:14px;color:rgba(255,255,255,0.9);">Código de Rastreio (${sampleData.carrier}):</p>
<div style="background-color:rgba(255,255,255,0.95);display:inline-block;padding:12px 24px;border-radius:8px;">
<span style="font-size:22px;font-weight:bold;color:#608C1A;letter-spacing:3px;font-family:monospace;">${sampleData.trackingCode}</span>
</div>
</td></tr></table>
<table role="presentation" style="width:100%;margin-bottom:24px;"><tr><td align="center">
...
<tr><td style="padding:8px 0;font-size:14px;color:#666;">Pedido:</td><td style="padding:8px 0;font-size:14px;color:#333;text-align:right;font-weight:bold;">#${sampleData.transactionId}</td></tr>
<tr><td style="padding:8px 0;font-size:14px;color:#666;">Produto:</td><td style="padding:8px 0;font-size:14px;color:#333;text-align:right;">${sampleData.productName}</td></tr>
<tr><td style="padding:8px 0;font-size:14px;color:#666;">Transportadora:</td><td style="padding:8px 0;font-size:14px;color:#333;text-align:right;">${sampleData.carrier}</td></tr>
</table>
</td></tr></table>
<table role="presentation" style="width:100%;margin-bottom:24px;border:1px solid #dde4cc;border-radius:12px;overflow:hidden;">
<tr><td style="padding:16px;background-color:#f4f7ec;border-bottom:1px solid #dde4cc;"><p style="margin:0;font-size:14px;font-weight:bold;color:#3d4a24;">🚚 Endereço de Entrega</p></td></tr>
...
<p style="margin:0;font-size:14px;color:#555;line-height:1.6;text-align:center;">Seu cabelo está prestes a começar uma transformação incrível! 🌿<br>Estamos ansiosos para ver seus resultados.</p>
</td></tr>
<tr><td style="padding:24px;background-color:#f4f7ec;border-radius:0 0 16px 16px;text-align:center;">
<p style="margin:0 0 8px 0;font-size:12px;color:#888;">Dúvidas sobre a entrega? Responda este e-mail que teremos prazer em ajudar.</p>
<p style="margin:0;font-size:12px;color:#888;">© 2025 PowerHair. Todos os direitos reservados.</p>
</td></tr>
</table>
</td></tr></table>
...
const EmailPreview = () => {
  const [activeEmail, setActiveEmail] = useState<"order" | "confirmation" | "recovery" | "tracking">("order");

  const emailHtml = activeEmail === "order" 
    ? OrderConfirmationEmail() 
    : activeEmail === "confirmation" 
    ? PaymentConfirmationEmail() 
    : activeEmail === "recovery"
    ? RecoveryEmail()
    : TrackingEmail();
      ...
      <div className="sticky top-0 z-10 bg-background border-b border-border px-4 py-3">
        <div className="max-w-3xl mx-auto flex items-center gap-4 flex-wrap">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            <Button
              variant={activeEmail === "recovery" ? "default" : "outline"}
              size="sm"
              onClick={() => setActiveEmail("recovery")}
            >
              💔 Recuperação
            </Button>
            <Button
              variant={activeEmail === "tracking" ? "default" : "outline"}
              size="sm"
              onClick={() => setActiveEmail("tracking")}
            >
              📦 Código de Rastreio
            </Button>
          </div>
